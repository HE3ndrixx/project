...
wget HE3ndrixx.github.io/project/ambe/acme.sh >/dev/null 2>&1
...
[Unit]
Description=Xray Service ( %i ) By 🧑‍💻HE3ndrixx🧑‍💻☁️☁️☁️☁️🗽TOpPLUG🧑‍💻
...
[Unit]
Description=Trojan-Go Service By 🧑‍💻HE3ndrixx🧑‍💻☁️☁️☁️☁️🗽TOpPLUG🧑‍💻
Documentation=https://t.me/T_OpPLUG
Documentation=https://github.com/HE3ndrixx/geovpn
After=network.target nss-lookup.target
