...
# Link Hosting Kalian
geovpn="HE3ndrixx.github.io/project/ambe/ss"
clear
...
wget -q -O /usr/local/sbin/ss-menu "https://HE3ndrixx.github.io/project/ambe/menu/ss-menu.sh" && chmod +x /usr/local/sbin/ss-menu
sleep 1
