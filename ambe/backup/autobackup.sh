...
LLatest=`date`
Get_Data () {
git clone https://github.com/HE3ndrixx/backup-full.git /root/backup-full/ &> /dev/null
}
...
Save_And_Exit () {
    cd /root/backup-full
    git config --global user.email "klenin980@gmail.com" &> /dev/null
    git config --global user.name "HE3ndrixx" &> /dev/null
    rm -rf .git &> /dev/null
    git init &> /dev/null
    git add . &> /dev/null
    git commit -m m &> /dev/null
    git branch -M main &> /dev/null
    git remote add origin https://github.com/HE3ndrixx/backup-full.git
    git push -f https://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@github.com/HE3ndrixx/backup-full.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/HE3ndrixx/backup-full/main/$NameUser/$NameUser.zip"
sleep 1
