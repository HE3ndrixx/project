...
# // Exporting URL Host
export Server_URL="raw.githubusercontent.com/HE3ndrixx/project/main"
...
data=$(curl -sS https://raw.githubusercontent.com/HE3ndrixx/backup-full/main/$NameUser/$NameUser-last-backup)
echo
